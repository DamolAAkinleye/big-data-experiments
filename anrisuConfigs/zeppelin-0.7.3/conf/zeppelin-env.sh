...
export MASTER=spark://ANRISU-LNX-03:7077
export SPARK_SUBMIT_OPTIONS="--jars /usr/local/hive-2.1.1/lib/mysql-connector-java.jar" 
#--packages org.apache.spark:spark-streaming_2.11:2.1.0,org.apache.kafka:kafka_2.11:0.10.2.0,org.apache.flume:flume-ng-auth:1.7.0,org.apache.spark:spark-streaming-flume_2.11:2.1.0,org.apache.spark:spark-streaming-flume-sink_2.11:2.1.0,org.apache.bahir:spark-streaming-twitter_2.11:2.1.0,com.datastax.spark:spark-cassandra-connector_2.11:2.0.0"
