...
docker run --net=anrisu-hadoop-network --name="horton-on-docker" --hostname="sandbox-hdp.hortonworks.com" --privileged -d \
-p 15500:15500 \
-p 15501:15501 \
-p 15502:15502 \
-p 15503:15503 \
...
docker exec -t horton-on-docker /root/start-sandbox-hdp.sh
